...
public class Console extends JFrame {
    ...
    private JPanel _pyrometers(){
    	...
    	JButton generation= new JButton("generuj świadetwa");
    ...
    public Console(){
    	...
    	add(_choosePath("Folder zapisu zapisek z wzorcowania",
    			"C:\\Users\\Laboratorium\\Desktop\\Laboratorium\\Wyniki wzorcowań\\Zapiski\\",
    			notes), c);
    	
    	c.gridy=3;
    	add(_choosePath("Folder zapisu świadectw wzorcowania",
    			"C:\\Users\\Laboratorium\\Desktop\\Laboratorium\\Wyniki wzorcowań\\Świadectwa wzorcowania\\", 
    			certificate), c);
